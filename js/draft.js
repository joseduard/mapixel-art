...
var app = {
    ...
    styles: ["plain", "empty", "light", "highlight", "higtligth2", "greenlight", "yellowligtht", "redlight" ],
    ...
    changeCellColor: function (event) {
      ...
      // le premier tour ma cellule n'a aucune de deux couleurs, docn on ajoute le colour green
      //   if (
